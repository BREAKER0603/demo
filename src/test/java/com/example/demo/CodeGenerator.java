 ...
 * @Author:SHIGS
 * @Description
 * @Date Created in 11:06 2018/6/29
 * @modified By
 */
public class CodeGenerator {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/demo";
    //private static final String JDBC_URL = "jdbc:mysql://172.18.19.138:3306/erui2_sys";
    ...
    // @author
    private static final String AUTHOR = "SHUAIGUO";
    // @date
